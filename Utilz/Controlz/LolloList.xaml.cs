...
{
	public sealed partial class LolloList : BackOrientOpenObservControl
	{
		#region properties
		...
		public static readonly DependencyProperty PopupContainerProperty =
			DependencyProperty.Register("PopupContainer", typeof(FrameworkElement), typeof(LolloList), new PropertyMetadata(Window.Current.Content));
		...
		public static readonly DependencyProperty SelectorVisibilityProperty =
			DependencyProperty.Register("SelectorVisibility", typeof(Visibility), typeof(LolloList), new PropertyMetadata(Visibility.Visible));
		...
		public static readonly DependencyProperty IsPopupOpenProperty =
			DependencyProperty.Register("IsPopupOpen", typeof(bool), typeof(LolloList), new PropertyMetadata(false, OnIsPopupOpen_PropertyChanged));
		private static void OnIsPopupOpen_PropertyChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
		{
			var me = obj as LolloList;            
			if (me == null) return;
		...
		public static readonly DependencyProperty PlaceholderTextProperty =
			DependencyProperty.Register("PlaceholderText", typeof(string), typeof(LolloList), new PropertyMetadata(DefaultPlaceholderText, OnPlaceholderText_PropertyChanged));
		private static void OnPlaceholderText_PropertyChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
		{
			LolloList me = obj as LolloList;
			if (me == null) return;
		...
		public static readonly DependencyProperty TextProperty =
			DependencyProperty.Register("Text", typeof(string), typeof(LolloList), new PropertyMetadata(null, OnText_PropertyChanged));
		...
		public static readonly DependencyProperty ListHeaderTextProperty =
			DependencyProperty.Register("ListHeaderText", typeof(string), typeof(LolloList), new PropertyMetadata(DefaultListHeaderText));
		...
		public static readonly DependencyProperty TextBlockStyleProperty =
			DependencyProperty.Register("TextBlockStyle", typeof(Style), typeof(LolloList), new PropertyMetadata(null));
		...
		public static readonly DependencyProperty AppBarButtonStyleProperty =
			DependencyProperty.Register("AppBarButtonStyle", typeof(Style), typeof(LolloList), new PropertyMetadata(null));
		...
		public static readonly DependencyProperty TextItemStyleProperty =
			DependencyProperty.Register("TextItemStyle", typeof(Style), typeof(LolloList), new PropertyMetadata(null));
		...
		public static readonly DependencyProperty ListHeaderStyleProperty =
			DependencyProperty.Register("ListHeaderStyle", typeof(Style), typeof(LolloList), new PropertyMetadata(null));
		...
		public static readonly DependencyProperty ItemsSourceProperty =
			DependencyProperty.Register("ItemsSource", typeof(Collection<TextAndTag>), typeof(LolloList), new PropertyMetadata(null)); //, OnItemsSource_PropertyChanged));
		...
		public static readonly DependencyProperty SelectedItemProperty =
			DependencyProperty.Register("SelectedItem", typeof(TextAndTag), typeof(LolloList), new PropertyMetadata(null, OnSelectedItem_PropertyChanged));
		...
		public static readonly DependencyProperty SelectedIndexProperty =
			DependencyProperty.Register("SelectedIndex", typeof(int), typeof(LolloList), new PropertyMetadata(-1));
        ...
        public static readonly DependencyProperty IsMultiSelectCheckBoxEnabledProperty =
            DependencyProperty.Register("IsMultiSelectCheckBoxEnabled", typeof(bool), typeof(LolloList), new PropertyMetadata(false));
